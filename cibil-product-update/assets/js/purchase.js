...
const PLAN_ORDER = {
  individual: ['premium-duo', 'premium', 'standard', 'basic', 'starter'],
  combo: ['premium-duo', 'premium', 'standard', 'basic']
};
...
function updateSummary() {
  ...
  document.getElementById('puTotalAmount').textContent = '₹' + price.toLocaleString('en-IN');
}
